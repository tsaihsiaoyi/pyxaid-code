...
void overlap(wfc &wfc1, int k1, int minband, int maxband, std::string filename)
{
  ...
  {
    cout << "Error in nac() : maximal band index is " << wfc1.nbands - 1 << ", given " << maxband << endl;
    exit(0);
  }
...
void energy(wfc &wfc1, int k, int minband, int maxband, std::string filename)
{
  ...
  if (maxband >= wfc1.nbands)
  {
    cout << "Error in energy() : maximal band index is " << wfc1.nbands - 1 << ", given " << maxband << endl;
    exit(0);
  }
...
void ham(wfc &wfc1, wfc &wfc2, int k1, int k2, int minband, int maxband, double dt, std::string filename)
{
  ...
  ******************************************************************/
  ...
  if (maxband >= wfc1.nbands)
  {
    cout << "Error in ham() : maximal band index is " << wfc1.nbands - 1 << ", given " << maxband << endl;
    exit(0);
  }
